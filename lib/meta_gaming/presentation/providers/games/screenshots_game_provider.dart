...
final screenshotsGameProvider = StateNotifierProvider<ScreenshotsMapNotifier,
    Map<String, List<Screenshots>>>((ref) {
  final gameRepository = ref.watch(gameRepositoryProvider);

  return ScreenshotsMapNotifier(
      getGameScreenshots: gameRepository.getScreenshotsById);
});
...
class ScreenshotsMapNotifier
    extends StateNotifier<Map<String, List<Screenshots>>> {
  final ScreenshotsCallback getGameScreenshots;

  ScreenshotsMapNotifier({required this.getGameScreenshots}) : super({});
